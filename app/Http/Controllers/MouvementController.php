...
class MouvementController extends AppBaseController
    ...
    public function index( Request $request )
 {
        ...
        $soldeDateURL = env( 'ALEASEPAY_SOLDE_DATE_URL', 'aleasepay_soldeDate' );
        if ( Auth::user() != null ) {
            ...
            //  echo '<pre>';
            // var_dump( $mouvements[ 0 ] );
            exit;

            $soldedeb = Http::post( $soldeDateURL, [
                'dateSolde' => $deb->format( 'd/m/Y' ),
                'compte' => $compte,

            ] );

            $soldefin = Http::post( $soldeDateURL, [
    ...
    public function create()
 {
    ...
    public function releve( $compte, $deb, $fin ) {
        ...
        */
        ...
        // $fpdf->Line( 100, $y, 100, $y+10 );
        $fpdf->Cell( 35, 5, ( $solde <= 0 )? number_format( $solde, 0, '', ' ' ):'', 0, 0, 'C', false );
