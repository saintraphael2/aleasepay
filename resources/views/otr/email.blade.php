...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <ul>
                <li><strong>Transaction Référence:</strong> {{ $data['referenceTransaction'] }}</li>
                <li><strong>Référence Déclaration:</strong> {{ $data['referenceDeclaration'] }}</li>
                <li><strong>Contribuable:</strong> {{ $data['contribuable'] }}</li>
