            ...
            <div id="loading-content" ></div>
                ...
                <div class="card logincardctz containerBlock">
                    ...
                    <div class="card-body login-card-body">
                        ...
                        <div class="iconlogin">
                            <h4 class="login-box-msg" style="color:black !important;">Mot Passe Perdu</h4>
                            <h4 class="login-box-msg" style="color:black !important;">Réinitialise ton mot de passe</h4>
                    ...
                    <form action="<?php echo e(route('reset.password.post')); ?>" method="POST" id="pwdform">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" 
                                 class="btn btn-block submit-color submitbtn">Modifier</button>
                            </div>  
                        </div>
                    </form>
                        <?php if($errors->any()): ?>
...
<script src="<?php echo e(asset('js/app.js')); ?>"></script>
    ...
    <?php /**PATH C:\Projets\aleasepay\resources\views/auth/forgetPasswordLink.blade.php ENDPATH**/ ?>