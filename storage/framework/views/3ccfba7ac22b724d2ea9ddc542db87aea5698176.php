...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <button type="submit" class="btn btn-primary btn-block"><?php echo e(__('auth.sign_in')); ?></button>
                    </div>
            ...
            <p class="mb-0">
                <a href="<?php echo e(route('register')); ?>" class="text-center"><?php echo e(__('auth.login.register_membership')); ?></a>
            </p>
        </div>
        <!-- /.login-card-body -->
    </div>
