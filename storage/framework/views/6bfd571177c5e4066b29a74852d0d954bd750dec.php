...
unset($__errorArgs, $__bag); ?>
                        <div id="formContainer">
                            ...
                            <div id="step1" class="step active">
                                <h3 style="text-align:center">Étape 1: Veuillez saisir votre matricule et votre email</h3>
                                <div style='display:none; color:red' id='checkmail'>Le mail saisi ne correspond pas au
                                    matricule.</div>
